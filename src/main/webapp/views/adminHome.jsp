...
<body class="bg-dark">
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
		<div class="container-fluid" style="background-color:rgb(174, 174, 219);border-color: red;">
	...
	<div class="jumbotron text-center" style="background-color:rgb(174, 174, 219);border-color: red;">
		<h1 class="display-4"><b>Admin Panel</b></h1><hr>
		<p>Manage your data from this Admin Panel</p>
	</div><br>
	<div class="container-fluid" >
		<div class="row justify-content-center">
			<div class="col-sm-3 pt-4">
			<!--  	<div class="card border border-info" style="background-color:rgb(174, 174, 219);border-color: red;">-->
				<div class="card" style="background-color:rgb(174, 174, 219);border-color: red;">	
